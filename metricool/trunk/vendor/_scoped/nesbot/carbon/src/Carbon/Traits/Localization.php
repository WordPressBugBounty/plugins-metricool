 ...
 */
namespace Metricool\Vendor\Carbon\Traits;

use Metricool\Vendor\Carbon\CarbonInterface;
use Metricool\Vendor\Carbon\Exceptions\InvalidTypeException;
use Metricool\Vendor\Carbon\Exceptions\NotLocaleAwareException;
use Metricool\Vendor\Carbon\Language;
use Metricool\Vendor\Carbon\Translator;
use Metricool\Vendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Metricool\Vendor\Symfony\Component\Translation\TranslatorBagInterface;
use Metricool\Vendor\Symfony\Component\Translation\TranslatorInterface;
use Metricool\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use Metricool\Vendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('Metricool\Vendor\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('Metricool\Vendor\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('Metricool\Vendor\Symfony\Contracts\Translation\TranslatorInterface', 'Metricool\Vendor\Symfony\Component\Translation\TranslatorInterface');
}
